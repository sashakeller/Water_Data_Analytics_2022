...
```{r}
as.factor(NeuseWQ_Processed$HydrologicCondition, levels=c("Not determined","Stable, low stage", "Falling stage", "Stable, normal stage", "Rising stage", "Stable, high stage", "Peak stage"))
