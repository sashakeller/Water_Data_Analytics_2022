...
Morphology (the shape/dimensions of the river), sediment, discharge (volume moving and how quickly), grade (slope), how sinuous the channel is (how much it winds and snakes (measured in sinuosity)).
...
>Verde river is ephemeral. 

perennial = always flowing
ephemeral = flow occasionally
