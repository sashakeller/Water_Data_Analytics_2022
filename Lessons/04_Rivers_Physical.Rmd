...
#data contains only 30 days of 1963 so we filter all years that are not 1963
...
#can't go directly from factor to numeric in R hence ^ ^ ^
...
#se is standard error, can flip that on.
