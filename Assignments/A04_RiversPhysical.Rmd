...
BitterDisch<-ggplot(BitterrootDischarge_summary, aes(x=WaterYear))+
  geom_point(aes(y=Discharge.acft.yr), color="red")+
  geom_point(aes(y=Baseflow.acft.yr), color="blue")+
  labs(x= element_blank(),y="Baseflow Proportion")+
  theme_dark()

BitterProp<-ggplot(BitterrootDischarge_summary, aes(x=WaterYear))+
  geom_point(aes(y=Baseflow.prop), color="green")+
...
plot_grid(BitterDisch,BitterProp,NehalemDisch,NehalemProp, ncol = 1, rel_heights = c(1, 1, 1, 1, 1.2),align = "hv")
