...
> I would expect natural lakes to be more resistant, perhaps, to the stress of increased phosphorous. However, reservoirs may be more closely managed and be made more resilient artificially. I would suspect that the mountains which are perhaps more hydrologically isolated/stagnant than the more flood prone coastal areas may be more susceptible to phosphorous stress with less flowing water to dilute it and refresh the waterbodies regularly. The Piedmont would represent a logical middle ground between the two.